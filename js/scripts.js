...
////////////reverse a string with reverse()////// 2nd segment//////////////
...
////////////reverse a string using forEach();
...
////MOST IMPRESSIVE WAY TO REVERSE A string
//
...
console.log(output);
// do the same thing with a negative but call * math.sign(int); to the return
